...
export const spellBookData: Record<SpellBookCard, SpellBookData> = {
  ...
  [SpellBookCard.SpellBook5]: { points: [5, 3], getMultiple: (game, player) => new SpellBookHelper(game, player).salamanderCount },
  [SpellBookCard.SpellBook6]: { points: [4, 2], getMultiple: (game, player) => new SpellBookHelper(game, player).divinityCount },
